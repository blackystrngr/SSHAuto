"""
WebSocket-to-TCP proxy – installs the working proxy script.
"""
...
# ----------------------------------------------------------------------
# The complete proxy script (embedded as a string)
# ----------------------------------------------------------------------
PROXY_SCRIPT_CONTENT = '''#!/usr/bin/env python3
"""
WebSocket-to-TCP proxy – works with nginx (fake 101 upgrade response).
"""
import logging
import select
import socket
...
# This fake response with a huge Content-Length keeps nginx happy
